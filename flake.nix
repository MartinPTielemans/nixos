{
  ...
  outputs =
    ...
    let
      # User configuration
      username = "martint"; # WARNING REPLACE THIS WITH YOUR USERNAME IF YOU ARE MANUALLY INSTALLING WITHOUT THE SCRIPT
      terminal = "alacritty"; # or kitty

      # System configuration
      locale = "en_DK.UTF-8"; # REPLACE THIS WITH YOUR LOCALE
      timezone = "Europe/Copenhagen"; # REPLACE THIS WITH YOUR TIMEZONE
    ...
    in
    {
      nixosConfigurations = {
        Default = lib.nixosSystem {
          inherit system;
          specialArgs = (arguments // { inherit inputs; }) // inputs; # Expose all inputs and arguments
          modules = [
